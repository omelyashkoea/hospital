...
import ru.homework.hospital.util.exception.ApplicationException;
import ru.homework.hospital.util.exception.ErrorInfo;
import ru.homework.hospital.util.exception.ErrorType;
import ru.homework.hospital.util.exception.IllegalRequestDataException;

import javax.servlet.http.HttpServletRequest;
import java.util.Map;
import java.util.Optional;

import static ru.homework.hospital.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    private static final Map<String, String> CONSTRAINS_I18N_MAP = Map.of(
            ...
            "visits_unique_user_datetime_idx", EXCEPTION_DUPLICATE_DATETIME);
