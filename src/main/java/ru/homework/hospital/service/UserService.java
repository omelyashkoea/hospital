...
import static ru.homework.hospital.util.UserUtil.prepareToSave;
import static ru.homework.hospital.util.ValidationUtil.checkNotFound;
...
//      checkNotFoundWithId : check works only for JDBC, disabled
    ...
    public User getWithVisits(int id) {
        return checkNotFoundWithId(repository.getWithVisits(id), id);
    }
}