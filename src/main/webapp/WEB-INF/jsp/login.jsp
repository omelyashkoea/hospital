        ...
        <sec:authorize access="isAnonymous()">
            <div class="pt-4">
                <button type="submit" class="btn btn-lg btn-primary" onclick="login('user@yandex.ru', 'password')">
                    <spring:message code="app.login"/> Терапевт
                </button>
                <button type="submit" class="btn btn-lg btn-primary" onclick="login('user@gmail.com', 'admin')">
                    <spring:message code="app.login"/> Невролог
                </button>
                <button type="submit" class="btn btn-lg btn-primary" onclick="login('admin@gmail.com', 'admin')">
                    <spring:message code="app.login"/> Админ
                </button>
            </div>
        </sec:authorize>
...
<div class="container lead">
    ...
    профилем и дневником посещения больных (дата/время, пациент, услуга) через UI с базовой авторизацией.
    Возможна фильтрация данных по датам и времени.
    Тестирование с использованием Spring MVC Test и Spring Security Test.
</div>
